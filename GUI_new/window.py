...
#         self.widg2.setLayout(self.resultssplitter)
    ...
    def resultsTreeItemClick(self, item, column):
        ...
        self.absView.setImage(np.abs(selected), autoRange=True, autoLevels=True, levels=None, axes=None, \
                                xvals=None, pos=None, scale=None, transform=None, autoHistogramRange=True)
        self.phaseView.setImage(np.angle(selected), autoRange=True, autoLevels=True, levels=None, axes=None, \
                                xvals=None, pos=None, scale=None, transform=None, autoHistogramRange=True)
