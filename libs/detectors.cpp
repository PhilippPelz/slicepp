...
Detector::Detector(int nx, int ny, float_tt resX, float_tt resY, float_tt wavelength, PersistenceManagerPtr persist)
  : m_error(0),
    m_shiftX(0),
    m_shiftY(0),
    m_nx(nx),
...
{
  return DetectorPtr(new Detector(m_nx, m_ny, m_dx, m_dy, m_wavelength,_persist));
}
