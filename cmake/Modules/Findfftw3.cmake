...
ELSEIF(UNIX)
	if(CLUSTER)
		find_library(FFTW3_LIBS fftw3 HINTS ~/local/lib)
		find_library(FFTW3F_LIBS fftw3f HINTS ~/local/lib)
		find_library(FFTW3_OMP_LIBS fftw3_omp HINTS ~/local/lib)
		find_library(FFTW3_THREAD_LIBS fftw3_threads HINTS ~/local/lib)
	else(CLUSTER)
		...
		find_library(FFTW3_THREAD_LIBS fftw3_threads HINTS $ENV{HOME}/lib /usr/lib /usr/local/lib)
	endif(CLUSTER)
...
if (NOT FFTW3_THREAD_LIBS)
  set(FFTW3_THREADS_FOUND FALSE)
endif (NOT FFTW3_THREAD_LIBS)
